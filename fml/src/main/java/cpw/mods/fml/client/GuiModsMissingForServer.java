...
public class GuiModsMissingForServer extends GuiScreen
{
    ...
    public void drawScreen(int p_73863_1_, int p_73863_2_, float p_73863_3_)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.error.modsMissingForServer.1"), this.width / 2, offset, 0xFFFFFF);
        offset += 10;
        this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.error.modsMissingForServer.2"), this.width / 2, offset, 0xFFFFFF);
        offset += 10;
        this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.error.modsMissingForServer.3"), this.width / 2, offset, 0xFFFFFF);
        offset += 5;
