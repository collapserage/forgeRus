...
public class GuiModsMissingForServer extends GuiScreen
{
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks)
    {
        ...
        this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.error.missingForServer.1"), this.width / 2, offset, 0xFFFFFF);
        offset += 10;
        this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.error.missingForServer.2"), this.width / 2, offset, 0xFFFFFF);
        offset += 10;
        this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.error.missingForServer.3"), this.width / 2, offset, 0xFFFFFF);
        offset += 5;
