...
public class GuiModList extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        configModButton = new GuiButton(20, 10, this.height - 49, this.listWidth, 20, I18n.format("adv.fml.button.config"));
        disableModButton = new GuiButton(21, 10, this.height - 27, this.listWidth, 20, I18n.format("adv.fml.button.disable"));
    ...
    public void drawScreen(int p_571_1_, int p_571_2_, float p_571_3_)
    {
        ...
        if (selectedMod != null)
        {
            ...
            else
            {
                ...
                this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.modList.noInfo.1", new Object[0]), offset, 75, 0xDDDDDD);
                this.drawCenteredString(this.fontRendererObj, I18n.format("adv.fml.modList.noInfo.2", new Object[0]), offset, 85, 0xDDDDDD);
